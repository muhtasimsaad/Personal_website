...
function Contact() {
  return (
    <>
      <div className="contact  mt-12 p-6  w-full">
        <div className="wrapper flex justify-center  bg-theme bg-opacity-90 py-16 lg:py-12">
          <div className="content-box w-1/3">
            <h1 className="text-white font-bold text-4xl ">Get In Touch</h1>
            <form action="" className="flex flex-col bg-red-800 ">
