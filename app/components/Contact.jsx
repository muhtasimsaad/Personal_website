...
const Contact = () => {
  ...
  return (
    <div className='flex h-screen my-auto snap-start'>
      ...
      <div className='w-full h-full p-8 m-auto lg:p-0 lg:h-auto lg:w-2/3'>
        {showAlert && <AlertMessage type={showAlertType} />}
        <div className='block my-auto lg:flex'>
          <div className='hidden w-full px-4 bg-red-100 lg:flex lg:w-1/2'>
          ...
          <div className='flex w-full mt-6 lg:w-1/2 lg:mt-0'>
            <form className='mx-auto lg:w-3/5 h-fit' ref={form}>
              ...
              <p className='mt-16 text-gray-100'>Name</p>
